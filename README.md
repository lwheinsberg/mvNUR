...
makefile to support installation. We have alerted the mvBIMABM software
maintainer of this issue, but have not seen it resolved. As such, we
provide a modified Mac download to make this process easier for users of
this tutorial (allowable under GNU General Public License (GPLv3+)).
...
commands. If you are new to Unix navigation via the terminal, please
...
1)  Download
    ...
    as Apple M1 or M2. If you have the Apple Intel, you will see the
    processor listed as Intel Core i5, i7, or similar.
