...
A copy of the original Makefile, modified Makefile, and a Word document comparing the two can be found in the `InstallationAppendix` folder of the [GitHub repository](https://github.com/lwheinsberg/mvNUR/tree/main/InstallationAppendix).
