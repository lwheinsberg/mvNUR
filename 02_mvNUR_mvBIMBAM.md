...
we will read in our stored lists of phenotypes/variants of interest
created in [`00_mvNUR_DataPrep.Rmd`](00_mvNUR_DataPrep.Rmd). See
...
./inputs/geno_bimbam.txt) -p: location of the phenotype data (for our
example the location is: ./inputs/pheno_bimbam.txt) -o: prefix for
output files (for our example we will use: bimbam_out) -f: number of
phenotypes to analyze (length(traits), for our example this number is 6)
-A: indicate multiple values for sigma (see mvBIMBAM manual for more
details; for our example we will use a range of values from 0.05 to 0.4)
-mph1 vs. mph2: analysis settings (see mvBIMBMAM manual for more details
and our note below; for this example we will run mph2) -r: random seed
...
|    SNP     |  BF   | BF_All_Partition | Anxiety | Depression | Fatigue |
|:----------:|:-----:|:----------------:|:-------:|:----------:|:-------:|
...
|       2.041        |  0.02955   |  3.437  |
|       0.2681       |   6.421    | 0.6853  |
|       6.156        |  0.00889   | -0.2024 |
|      0.05509       |  -0.05979  | -0.1757 |
|       5.586        |   4.684    |  11.63  |
|       0.5971       |  -0.3565   | 0.2123  |
...
none of the individual phenotypes themselves (BFs \< 1.5), while bnlearn
omitted it completely. It’s worth mentioning that you can modify the
default priors to be more conservative (see software documentation), but
...
```
    ...
    ## [21] vctrs_0.6.1      hms_1.1.3        bit64_4.0.5      grid_4.2.1      
    ## [25] tidyselect_1.2.0 glue_1.6.2       R6_2.5.1         fansi_1.0.4     
    ## [29] vroom_1.6.1      rmarkdown_2.21   tzdb_0.3.0       magrittr_2.0.3  
    ## [33] scales_1.2.1     htmltools_0.5.5  colorspace_2.1-0 utf8_1.2.3      
    ## [37] stringi_1.7.12   munsell_0.5.0    crayon_1.5.2
